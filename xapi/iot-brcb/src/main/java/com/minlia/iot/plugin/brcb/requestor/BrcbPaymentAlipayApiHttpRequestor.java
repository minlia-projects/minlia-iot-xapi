 ...
 */
public class BrcbPaymentAlipayApiHttpRequestor<REQUEST extends BrcbPaymentApiHttpRequestBody, RESPONSE extends BrcbApiHttpResponseBody> extends
    DefaultApiHttpRequestor<REQUEST, RESPONSE> {


  public BrcbPaymentAlipayApiHttpRequestor(ApiProcessor<REQUEST, RESPONSE> apiProcessor) {
    super(apiProcessor);
  }
