 ...
 */
@Slf4j
public class BrcbCustomerServiceSignatureProcessor<REQUEST extends BrcbCustomerServiceApiHttpRequestBody> extends
    DefaultXmlSignatureProcessor<REQUEST> {

  @Override
  public String sign(BrcbCustomerServiceApiHttpRequestBody requestBody, ApiRuntimeContext context) {
    //将签名后的值绑定到签名字段上 sign
    ...
    signatureBody.setSalt(
        ((BrcbCustomerServiceApiCredentialConfiguration) context.getPreferApiCredentialConfiguration())
            .getAgentKey());
