 ...
 */
@Slf4j
public class BrcbSettleSignatureProcessor<REQUEST extends BrcbSettleApiHttpRequestBody> extends
    DefaultXmlSignatureProcessor<REQUEST> {

  @Override
  public String sign(BrcbSettleApiHttpRequestBody requestBody, ApiRuntimeContext context) {
    //将签名后的值绑定到签名字段上 sign
    ...
    signatureBody.setSalt(
        ((BrcbSettleApiCredentialConfiguration) context.getPreferApiCredentialConfiguration())
            .getMchKey());
