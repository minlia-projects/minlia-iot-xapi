 ...
 * 最终Api样例
 */
public class SeansetimeApi extends AbstractJsonApi {

    //如果需要创建BUILDER方法, 取消注释即可
    @Override
    public SeansetimeApi sandbox(Boolean sandbox) {
     ...
     * 如果一个都没有则报错
     */
    public SeansetimeApi(ApiCredentialConfiguration[] apiCredentialConfiguration,
