...
//    requestBody.setOpenid("oZtcE0aIoRluOZ4XbfdHZFB6zG");
    ...
    //设置为沙箱模式
    seansetimeApi.sandbox(false);
    SwiftpassStatefulApiResponseBody statefulApiResponseBody = seansetimeApi
...
//
//    //设置为沙箱模式
//    seansetimeApi.sandbox(true);
//    SwiftpassStatefulApiResponseBody statefulApiResponseBody = seansetimeApi.wechatMicropay(requestBody);
//
//    assertNotNull(statefulApiResponseBody);
//    assertTrue(statefulApiResponseBody.isSuccess());
//
...
//    //设置为沙箱模式
//    seansetimeApi.sandbox(true);
//    SwiftpassStatefulApiResponseBody statefulApiResponseBody = seansetimeApi.wechatNativePayment(requestBody);
//
//    assertNotNull(statefulApiResponseBody);
//    assertTrue(statefulApiResponseBody.isSuccess());
//
